...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "buy":
        ...
        await query.edit_message_text(text, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔙 برگشت", callback_data="admin")]]))
        ...
        for admin_id in ADMIN_IDS:
            ...
            await context.bot.send_photo(
                ...
                caption=(f"🧾 سفارش جدید #{order_id}\n"
                         f"👤 یوزر: {update.effective_user.id}\n"
                         f"📦 پلن: {plan.get('name','')}\n"
                         f"💾 حجم: {volume_text}\n"
